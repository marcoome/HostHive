...
class Settings(BaseSettings):
    ...
    FERNET_SALT: str = Field(
        default="",
        description="Random hex salt for Fernet key derivation (generated by installer).",
    )
    ...
    WEBAUTHN_RP_ID: str = Field(
        default="",
        description="Relying Party ID for WebAuthn (defaults to PANEL_DOMAIN hostname).",
    )
    WEBAUTHN_RP_NAME: str = Field(
        default="NovaPanel",
        description="Human-readable Relying Party name shown in passkey prompts.",
    )
    WEBAUTHN_ORIGIN: str = Field(
        default="",
        description="Expected WebAuthn origin (defaults to https://<PANEL_DOMAIN>).",
    )
