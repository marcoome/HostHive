<template>
  <div class="card p-0 overflow-hidden">
      ...
      <table class="w-full">
        <thead>
          <tr class="border-b border-border">
            ...
            <th v-if="$slots.actions" class="px-6 py-3 text-right text-xs font-semibold text-text-muted uppercase tracking-wider">
              Actions
            </th>
          </tr>
        </thead>
    ...
    <!-- Pagination -->
    <div v-if="totalPages > 1" class="px-6 py-3 border-t border-border flex items-center justify-between">
